...
<div class="py-5 text-center">
    <div class="container">
        ...
        <div class="row" style="">
            ...
            <div class="col-lg-2 p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="https://static.pingendo.com/img-placeholder-1.svg" width="150">
                <h4> <b>J. G. Wolf</b> </h4>
                <p class="mb-0">CFO</p>
            </div>
            <div class="col-lg-2 p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="https://static.pingendo.com/img-placeholder-1.svg" width="150">
            ...
            <div class="col-md-12">
                <div class="carousel slide" data-ride="carousel" id="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item"> <img class="d-block img-fluid w-100" src="https://static.pingendo.com/cover-bubble-dark.svg" height="1px">
                            <div class="carousel-caption">
                                <h5 class="m-0">Carousel</h5>
                                <p>with controls</p>
                            </div>
                            <div class="row">
                                <div class="col-lg-6  p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="https://static.pingendo.com/img-placeholder-2.svg" width="150" alt="Card image cap">
                                    <h4> <b>G. W. John</b> </h4>
                                    <h4> <b>G. W. John</b> </h4>
                                    <p class="mb-0">Co-founder</p>
                                </div>
                                <div class="col-lg-6  p-4"> <img class="img-fluid d-block mb-3 mx-auto rounded-circle" src="https://static.pingendo.com/img-placeholder-3.svg" width="150">
                                    <h4> <b>J. G. Wolf</b> </h4>
                                    <p class="mb-0">CFO</p>
                                </div>
                            </div>
