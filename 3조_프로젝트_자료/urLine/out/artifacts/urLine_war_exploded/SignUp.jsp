...
<nav class="navbar navbar-expand-md navbar-dark bg-transparent fixed-top" style="">
    ...
    </a> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar16" style="">
    ...
    <div class="container">
        <div class="row text-dark" style="">
            <div class="mx-auto col-lg-6 px-5 border-left border-right">
                ...
                <form class="text-center" method="POST" autocomplete="off" action="SignUp_process2.jsp" onsubmit="return pwCheck()"
                      name="userInfo">
                    <div class="row">
                            ...
                            <div class="form-group"> <label for="id">이메일</label>
                                <div class="row">
                                    <div class="col-md-9 pr-0" style="">
                                        <input type="text" name="id" class="form-control" id="id" onchange="idConditionCheck()" placeholder="j.goethe@werther.com">
                                    </div>
                                    <div class="col-md-3 pl-1 pr-2" style="">
                                        <input type="button" name="confirm_id" value="중복확인" OnClick="openConfirmid(this.form)" class="btn my-auto border-primary btn-light" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-row text-center">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="password" id="rePw" name="rePw" class="form-control" id="rePw" placeholder="••••">
                        </div>
                    </div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 mb-3"><small class="text-muted"> ※ 비밀번호는 8자리 이상 숫자, 문자의 조합으로 작성해 주십시오.</small></div>
                        </div>
                    </div>
                    <div class="form-group" draggable="true"><label for="name">이름</label> <input type="text"name="name" class="form-control text-center" id="name" onchange="nameConditionCheck()" placeholder="두 글자 이상의 한글로 작성해 주십시오"> </div>
                    <div class="form-group"> <label for="nickname">닉네임</label> <input type="text" name="nickname" class="form-control text-center" id="nickname" onchange="nicknameConditionCheck()"placeholder="두 글자 이상의 한글로 작성해 주십시오"> </div>
                    <div class="form-group"> <label for="phone">휴대폰 번호</label> <input type="text" name="phone" class="form-control text-center" id="phone" onchange="phoneConditionCheck()" placeholder="010AAAABBBB"> </div>
                    <div class="container">
                        <div class="row">
                        </div>
                        <div class="row">
                    ...
                    <input type="submit" value="가입하기" id="joinBtn" class="btn border-primary btn-light" disabled='disabled'/>
                </form>
            </div>
        </div>
    </div>
